...
<head>
    ...
    <LINK REL=StyleSheet HREF="css/skin_envio.css">
</head>
<body>
    <img src="img/logo.jpg" >
    <div class= "portada"><h2><br>Modos de Envios por <strong>Mundo Express</strong><br></h2></div>
    ...
    <label class="negrita">Vía Marítima:</label> Tarda dependiendo del lugar a entregar el paquete (sin contar aduanas),
     ...
     teniendo en cuenta pueden tardar mínimo 4 y máximo 7 días.<br><br>
